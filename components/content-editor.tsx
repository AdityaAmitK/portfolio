                ...
                <div className="engagement-editor">
                  ...
                  {experience.engagements.map((engagement, engagementIndex) => (
                    <div className="admin-form engagement-editor__item" key={engagementIndex}>
                      ...
                      <div className="field"><label>Tags (comma separated)</label><input value={engagement.tags.join(',')} onChange={event => updateEngagement(experienceIndex, engagementIndex, { tags: event.target.value.split(',') })} /></div>
            ...
            <details className="admin-card" key={index}>
              ...
              <div className="admin-form content-fields">
                ...
                <div className="form-row">
                  ...
                  <div className="field"><label>Tags (comma separated)</label><input value={project.tags.join(',')} onChange={event => updateProject(index, { tags: event.target.value.split(',') })} /></div>
                </div>
