...
export async function updateContent(formData: FormData) {
  ...
  if (!Array.isArray(content.projects) || !Array.isArray(content.experiences) || !Array.isArray(content.tools) || !Array.isArray(content.skills) || !content.about || typeof content.about.headline !== 'string' || typeof content.about.body !== 'string') throw new Error('Invalid content')
