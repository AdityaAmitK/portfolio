...
export default function ProjectsPage() {
  ...
  const projectYear = (project: typeof projects[number]) => project.date ? Number(project.date.slice(0, 4)) : project.year
  const projectDate = (project: typeof projects[number]) => project.date ? new Date(`${project.date}T00:00:00`).toLocaleDateString('en-IN', { day: 'numeric', month: 'long', year: 'numeric' }) : null
